...
if __name__ == "__main__":
    main()
--------------------------------------------------------------------------------------------------------
# Separate the rendering of previous messages from the latest assistant response and Ensure the streaming logic only applies to the latest assistant response after processing the user input
